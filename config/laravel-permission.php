...
return [
    ...
    */
    ...
    'models' => [
        ...
        | `Star\Permission\Contracts\Permission` contract.
        |
        */

        'permission' => Star\Permission\Models\Permission::class,
        ...
        | `Star\Permission\Contracts\Role` contract.
        |
        */

        'role' => Star\Permission\Models\Role::class,
